class SendLosingSlateMessageJob < BudweiserJob
  ...
  def perform user_id
    ...
    FacebookMessaging::Standard.deliver(user, "On the bright side, there are some more Sweep questions available that you can answer by typing 'More contests' below 👇", "NO_PUSH")
