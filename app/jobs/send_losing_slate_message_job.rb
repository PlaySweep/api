class SendLosingSlateMessageJob < BudweiserJob
  ...
  def perform user_id
    ...
    FacebookMessaging::TextButton.deliver(user, "See Available Contests", "On the bright side, there are some more questions available that you can answer by tapping below 👇", "NO_PUSH")
  end
end