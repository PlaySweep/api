class SendSlateNotificationJob < BudweiserJob
  ...
  def perform user_id
    ...
    if user.cards.size > 1
      ...
      FacebookMessaging::Standard.deliver(user, "Congratulations on answering all of the questions for your first Budweiser Sweep Contest, #{user.first_name}! You’ll be updated on your status as early as the morning after the game.", "NO_PUSH")
