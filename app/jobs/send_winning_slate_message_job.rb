class SendWinningSlateMessageJob < ApplicationJob
  ...
  def perform user_id
    ...
    FacebookMessaging::Standard.deliver(user, "#{user.first_name}, you completed a Budweiser Sweep last night and got all 3 right!", "REGULAR_PUSH")
    ...
    FacebookMessaging::TextButton.deliver(user, "See Available Contests", "Oh, and don’t forget to answer the next Sweep questions for another chance to win 👇", "SILENT_PUSH")
  end
end