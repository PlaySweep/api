class SendWinningSlateMessageJob < BudweiserJob
  ...
  def perform user_id
    ...
    FacebookMessaging::Standard.deliver(user, "Oh, and don’t forget to answer the next Sweep questions for another chance to win! Just type 'Budweiser contests' below 👇", "NO_PUSH")
