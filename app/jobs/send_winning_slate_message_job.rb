class SendWinningSlateMessageJob < BudweiserJob
  ...
  def perform user_id
    ...
    FacebookMessaging::TextButton.deliver(user, "See Available Contests", "Oh, and don’t forget to answer the next Sweep questions for another chance to win by tapping below 👇", "SILENT_PUSH")
  end
end