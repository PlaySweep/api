class SendWinnerConfirmationJob < ApplicationJob
  ...
  def perform slate_id, user_id
    ...
    FacebookMessaging::Standard.deliver(user, "Congratulations #{user.first_name}, you were selected as our drawing winner for #{slate.prizes.first.product.name}🎉! ", "REGULAR")
